<template>
  <li
    class="project grid gap-4 md:gap-8 md:grid-cols-7 items-center mb-8 md:mb-12"
  >
    <header
      style="height: min-content"
      class="md:grid md:col-start-5 md:col-end-8"
    >
...
export default {
  ...
  computed: {
    coverImageUrl() {
      ...
      const imagePath = this.project.cover.data.attributes.formats.thumbnail.url
